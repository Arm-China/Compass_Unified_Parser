...
onnx_attr_convert_mapping = [
    ...
    ('TENSOR', lambda pb: get_tensor_content(pb.t).get('tensor', None)),
    ...
    ('TENSORS', lambda pb: list(content.get('tensor', None) for content in map(get_tensor_content, pb.tensors))),
