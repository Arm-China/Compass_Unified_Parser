...
def merge_query_rebatch(graph):
    ...
    matches = matched_patterns(graph,
                               nodes=[
                                   ...
                                   ('g0', {'op': 'Gather'}),
                                   ('ec', {'op': 'Constant', 'unique': False}),
                                   ('e0', {'op': 'Expand'}),
                                   ('rc', {'op': 'Constant', 'unique': False}),
                                   ('r0', {'op': 'Reshape'}),
                               ...
                               edges=[
                                   ...
                                   ('ec', 'e0', {'src_out_port': 0, 'dst_in_port': 1}),

                                   ('e0', 'r0', {'src_out_port': 0, 'dst_in_port': 0}),
                                   ('rc', 'r0', {'src_out_port': 0, 'dst_in_port': 1}),
                                   ...
                                   ('ec', 'e1', {'src_out_port': 0, 'dst_in_port': 1}),

                                   ('e1', 'r1', {'src_out_port': 0, 'dst_in_port': 0}),
                                   ('rc', 'r1', {'src_out_port': 0, 'dst_in_port': 1}),
                                   ...
                                   ('ec', 'e2', {'src_out_port': 0, 'dst_in_port': 1}),

                                   ('e2', 'r2', {'src_out_port': 0, 'dst_in_port': 0}),
                                   ('rc', 'r2', {'src_out_port': 0, 'dst_in_port': 1}),
                                   ...
                                   ('ec', 'e3', {'src_out_port': 0, 'dst_in_port': 1}),

                                   ('e3', 'r3', {'src_out_port': 0, 'dst_in_port': 0}),
                                   ('rc', 'r3', {'src_out_port': 0, 'dst_in_port': 1}),
                                   ...
                                   ('ec', 'e4', {'src_out_port': 0, 'dst_in_port': 1}),

                                   ('e4', 'r4', {'src_out_port': 0, 'dst_in_port': 0}),
                                   ('rc', 'r4', {'src_out_port': 0, 'dst_in_port': 1}),
                                   ...
                                   ('ec', 'e5', {'src_out_port': 0, 'dst_in_port': 1}),

                                   ('e5', 'r5', {'src_out_port': 0, 'dst_in_port': 0}),
                                   ('rc', 'r5', {'src_out_port': 0, 'dst_in_port': 1}),
