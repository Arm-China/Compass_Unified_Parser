...
tf_types_convert_mapping = [
    ...
    ('DT_BFLOAT16', 'bfloat16', lambda pb: tf.io.parse_tensor(pb.SerializeToString(), out_type=tf.bfloat16).numpy()),
    ...
    ('DT_HALF', np.float16, lambda pb: tf.io.parse_tensor(pb.SerializeToString(), out_type=tf.float16).numpy()),
