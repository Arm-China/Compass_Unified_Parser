...
class TfKerasSeparableConv2DOp(KerasBaseConvOp):
    ...
    def __init__(self, graph, attr_dict=None):
        super(TfKerasSeparableConv2DOp, self).__init__(graph, attr_dict)
        self.update_attributes(TfKerasSeparableConv2DOp, attr_dict)
    ...
    def infer_shape(self):
        super(TfKerasSeparableConv2DOp, self).infer_shape()
