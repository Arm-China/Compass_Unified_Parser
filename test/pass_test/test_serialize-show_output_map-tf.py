...
for input_shape in input_shapes:
    ...
    exit_status = run_parser(model_path, feed_dict, output_names=['Y1', 'Y2'],
                             expected_logs=['Output Y1 from cfg is shown as tensor Y1_0 in IR',
                                            'Output Y2 from cfg is shown as tensor Y2_0 in IR'])
    assert exit_status
