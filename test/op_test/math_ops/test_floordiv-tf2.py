...
def create_floordiv_model(model_path, x_shape, y_shape):
    ...
    floordiv = tf.math.floordiv(x1, x2)
    y = tf.math.add(10.1, floordiv, name='Y')
...
# Create model
create_floordiv_model(model_path, input_shape1, input_shape2)
