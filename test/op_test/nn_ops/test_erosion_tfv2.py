...
def create_erosion_model(pb_file_path, input_size):
    ''' Create tensorflow model for erosion op.
    '''
    try:
...
# Create model
model_created = create_erosion_model(model_path, input_shape)
